...
public class RudeTopic extends Topic {
	...
	private static final List<String> replies = Arrays.asList(
		...
		"scrub",
		"lol",
		"You can't sing. You can't dance. What do you have to say for yourself?",
		"I was minding my business. I didn't ask to be needlessly pinged.",
		"Piss off",
		"Go away. Do not pass GO. Do not collect $200.",
		"Don't push me."
	);
	
	private static final List<String> condescendingToken = Arrays.asList(
		"w/e", "buddy", "pal", "twat", "idiot", "dummy", "sure", "uhuh"
	);
