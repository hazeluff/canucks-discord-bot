 ...
 */
public class OLD_NHLGameDayChannelsManager extends Thread {
	private static final Logger LOGGER = LoggerFactory.getLogger(OLD_NHLGameDayChannelsManager.class);
	...
	public OLD_NHLGameDayChannelsManager(NHLBot nhlBot) {
		this.nhlBot = nhlBot;
	...
	public void updateChannels(Guild guild) {
		try {
			...
			LOGGER.info("Updating Channels for [{}]: activeGames={}", guild.getId().asLong(),
